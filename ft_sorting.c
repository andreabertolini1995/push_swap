...
static void    rotate_or_reverse_rotate(t_stack **stack_a, t_stack **stack_b, int number_to_push, int highest_lower)
{
    ...
    //ft_print_rotations(rotations_stack_a, rev_rotations_stack_a, rotations_stack_b, rev_rotations_stack_b);
    ...
    // Case 3. Rotations on stack A and reverse rotations on stack B
    ...
    // Case 4. Rotations on stack B and reverse rotations on stack A
    else
